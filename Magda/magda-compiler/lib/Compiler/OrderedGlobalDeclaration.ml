...
let compare (d1:t) (d2:t) = match d1, d2 with
	| PolymorphysmDecl _, LetDecl _ -> 1
	| PolymorphysmDecl _, MixinDecl _ -> 1
	| LetDecl _, PolymorphysmDecl _ -> -1
	| MixinDecl _, PolymorphysmDecl _ -> -1
	...
	| PolymorphysmDecl p_d1, PolymorphysmDecl p_d2 -> String.compare p_d1.poly_name p_d2.poly_name
